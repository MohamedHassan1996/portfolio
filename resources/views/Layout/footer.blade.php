      ...
      <div class="flex gap-[64px] flex-wrap ">
        <div class="w-[450px] flex flex-col gap-[28px]">
          ...
          <div class="address">
            ...
            <p class="text-[#FBFCF8] font-[100]">{{ app()->getLocale() == 'en' ? 'Behind Sindoub Insurance Hospital, above Basmala Center for Physiotherapy , Mansoura, Egypt' : 'خلف مستشفى التأمين بسندوب، فوق مركز بسملة للاستشفاء الطبي، المنصورة، مصر'   }}</p>
          </div>
