                                ...
                                @foreach ($blogs as $blog)
                                    <div
                                        ...
                                        <img src="{{ url("storage/$blog->thumbnail") }}"
                                            class="w-full h-full rounded-lg" alt="image1" loading="lazy">
                                        <div
                                        ...
                                        <div
                                            ...
                                            <h2
                                                class="[font-family:Montserrat,sans-serif] text-[35px] font-semibold leading-[42px] text-[#333333] p-0 m-0 w-full">
                                                {{ $blog->title }}
                                            </h2>
                                            <p
